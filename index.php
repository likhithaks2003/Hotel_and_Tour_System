...
?>
    ...
    <header class="py-5 bg-image-full" style="background-image: url('images/slide-3.jpg'); height:300px">
    ...
    <section class="py-5 bg-image-full" style="background-image: url(images/slide-3.jpg);">
    ...
    <footer class="py-5 bg-inverse">
      <div class="container">
        <p class="m-0 text-center ">TCR_Innovation &copy; Hotel & Tourism</p>
      </div>
      <!-- /.container -->
    </footer>
